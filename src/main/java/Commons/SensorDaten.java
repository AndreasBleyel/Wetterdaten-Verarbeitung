...
/**
 * SensorDaten ist ein POJO um die die durch die Sensoren generierten Daten zu halten. In der
 * Simulation werden durch die create*() Methoden zufallsgenerierte Daten erzeugt.
 */
public class SensorDaten implements Serializable {
  ...
  /**
   * Bei der Erzeugen eines Objekt dieser Klasse, werden die Daten automatisch im Konstruktor
   * generiert.
   */
  public SensorDaten() {
    random = new Random();
  ...
  /**
   * Random Variable nur in der Simulation notwendig.
   */
